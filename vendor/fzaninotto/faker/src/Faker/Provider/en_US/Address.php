...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $country = array(
        ...
        'Macao', 'Macedonia', 'Madagascar', 'Malawi', 'Malaysia', 'Maldives', 'Mali', 'Malta', 'Marshall Islands', 'Martinique', 'Mauritania', 'Mauritius', 'Mayotte', 'Mexico', 'Micronesia', 'Moldova', 'Monaco', 'Mongolia', 'Montenegro', var(--english-font), 'Morocco', 'Mozambique', 'Myanmar',

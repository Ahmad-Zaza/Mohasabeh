...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong><i class='{{ CRUDBooster::getCurrentModule()->icon }}'></i> {!! 'Set Customer Subscription' !!}</strong>
        </div>

        <div class="panel-body" style="padding:20px 0px 0px 0px">
            <?php $action = CRUDBooster::mainpath('saveSubscription'); ?>
            <form class='form-horizontal was-validated' method='post' id="form" enctype="multipart/form-data"
                ...
                <div class="box-body" id="parent-form-area">
                    ...
                    <div class='form-group form-datepicker' id='form-group-subscription-start-date'
                        style="{{ @$form['style'] }}">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type='text' title="Subscription Start Date" required
                                    ...
                                    id="subscription-start-date" value='{{ $value }}' />
                            </div>
                    ...
                    <div class='form-group form-datepicker' id='form-group-subscription-start-date'
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon open-datetimepicker"><a><i
                                            class='fa fa-calendar '></i></a></span>
                                <input type='text' title="Subscription End Date" required
                                    class='form-control notfocus input_date' name="subscription-end-date"
                                    id="subscription-end-date" value='{{ $value }}' />
                            </div>
                            <div class="text-danger">{!! $errors->first($name) ? "<i class='fa fa-info-circle'></i> " . $errors->first($name) : '' !!}</div>
                        </div>
                    </div>

                    ...
                    <div class='form-group form-datepicker' id='form-group-free-trial-start-date'
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type='text' title="Free Trial Start Date" required
                                    class='form-control notfocus input_date' name="free-trial-start-date"
                                    id="free-trial-start-date" value='{{ $value }}' />
                            </div>
                    ...
                    <div class='form-group form-datepicker' id='form-group-free-trial-start-date'
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon open-datetimepicker"><a><i
                                            class='fa fa-calendar '></i></a></span>
                                <input type='text' title="Free Trial End Date" require
                                    class='form-control notfocus input_date' name="free-trial-end-date"
                                    id="free-trial-end-date" value='{{ $value }}' />
                            </div>
                            <div class="text-danger">{!! $errors->first($name) ? "<i class='fa fa-info-circle'></i> " . $errors->first($name) : '' !!}</div>
                        </div>
                    </div>

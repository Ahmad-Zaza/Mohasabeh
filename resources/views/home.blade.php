            ...
            <div class="row">
                ...
                <form id="contact-form" class="col-sm-6 col-md-offset-1 scrollimation fade-left d3" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input id="contact-name" type="text" name="name" placeholder="{{ __('data.your_name') }}"
                                class="form-control requiredField required" data-new-placeholder="Your name"
                    ...
                    <div class="form-group">
                        ...
                        <div class=" controls">
                            <input id="contact-mail" type="email" name="email" placeholder="{{ __('data.your_email') }}"

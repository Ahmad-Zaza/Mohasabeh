                            ...
                            <div class="product-card product-card-primary">
                                ...
                                <div class="card-hero">
                                    ...
                                    <div class="product-ctas">
                                        ...
                                        @else
                                        <a type="button" href="javascript:void(0)" data-package-id={{ $pkg->id }} class="sub_now js-product-buy-now button button-medium button-primary button-default " data-product="Suite" target="" style="width:100%;">{{ __('data.subscribe_now') }}</a>
                                        @endif
                                    </div>
                                </div>

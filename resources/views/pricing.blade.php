                                        ...
                                        <div class="card-hero">
                                            ...
                                            <div class="price-lockup">
                                                ...
                                                <p class="price" style="text-align: center;">
                                                    ...
                                                    <span class="katamari-field agent"
                                                        data-katamari-field-id="11">{{ $pkg["description_$lang"] }}</span>

                                                </p>

                                                <div class="form-group">

                                                    <input type="hidden" id="subscription_type_{{ $pkg->id }}"
                                                        class="subscription_type"
                                                        name="subscription_type_{{ $pkg->id }}" value="month" />
                                                    <input type="hidden" id="pkgg_id" class="pkgg_id" name="pkgg_id"
                                                        value="{{ $pkg->id }}" />
                                                    ...
                                                    <select class="form-control subscription_ttype"
                                                        ...
                                                        <option value="month-{{ $pkg['monthly_price'] }}" selected>
                                                            {{ __('data.monthly_pricing') }}
                                                        </option>

                                                        <option value="six_month-{{ $pkg['six_month_price'] }}">
                                                            {{ __('data.six_month_pricing') }}
                                                        </option>

                                                        <option value="year-{{ $pkg['year_price'] }}">
                                                            {{ __('data.yearly_pricing') }}
                                                        </option>
                                                ...
                                                <p class="price" style="text-align: center;">
                                                    ...
                                                    <span class="katamari-field amount text-center" data-pricingplan="team"
                                                        data-katamari-field-id="10"
                                                        style="font-size:26px;font-style: italic"
                                                        id="dy_amnt_pkg_{{ $pkg->id }}"><strong>${{ $pkg['monthly_price'] }}</strong></span>
                                            ...
                                            <div class="product-ctas">
                                                ...
                                                @else
                                                    <a type="button" href="javascript:void(0)"
                                                        ...
                                                        class="sub_now js-product-buy-now button button-medium button-primary button-default "
                                                        data-product="Suite" target=""
                                                        style="width:100%;">{{ __('data.subscribe_now') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-card product-card-primary">
                                        ...
                                        @foreach ($pkg->price_pkg_main_options as $item)
                                            <div class="pb-1 nowrap text-{{ $_left }}"
                                                style="padding-{{ $_left }}:10px;">

                                                <div class="form-holder"><strong
                                                        class="mr-1">{{ $item['value'] }}</strong>
                                        ...
                                        <ul class="feature-list">
                                            ...
                                            @foreach ($reports as $item)
                                                <li class="katamari-field  text-{{ $_left }}"
                                                    data-katamari-field-id="35" data-katamari-field-type="html">
                                                    ...
                                                    <div style="float:{{ $_left }}">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="27"
                                                            ...
                                                            <g id="Group_2743" data-name="Group 2743"
                                                                ...
                                                                <circle id="Ellipse_1" data-name="Ellipse 1" cx="13.5"
                                                                    cy="13.5" r="13.5"
                                                                    transform="translate(319 730)" fill="#fff" />
                                                                ...
                                                                <path id="Icon_awesome-check" data-name="Icon awesome-check"
                                                                    ...
                                                                    transform="translate(323.874 732.923)"
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="tooltip">
                                                            ...
                                                            <span
                                                                class="tooltip-content tooltip-content-{{ $_left }}">
    ...
    <script>
        $(function() {
            ...
            $('.subscribe_now').click(function() {
                ...
                $('#subscribeModal').find(".modal-header").html(title + " (" + $(this).attr(
                    "package_name") + ")");
            ...
            $('.sub_now').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            window.location.href = '/profile/checkout/subscribe';
                        }
                    }
                });
            });

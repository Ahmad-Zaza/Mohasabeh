                                        ...
                                        <div class="card-hero">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control subscription_ttype"
                                                        ...
                                                        <option value="month-{{ $pkg['monthly_price'] }}" selected>
                                                            {{ __('data.monthly_pricing') }}</option>

                                                        <option value="six_month-{{ $pkg['six_month_price'] }}">
                                                            {{ __('data.six_month_pricing') }}</option>

                                                        <option value="year-{{ $pkg['year_price'] }}">
                                                            {{ __('data.yearly_pricing') }}</option>
                                            ...
                                            <div class="product-ctas">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="js-product-buy-now button button-medium button-primary button-default subscribe_now"
                                                    data-product="Suite" target="" style="width:100%;"
                                                    package_id="{{ $pkg->id }}"
                                                    package_name="{{ $pkg["title_$lang"] }}">{{ __('data.subscribe_now') }}</a>

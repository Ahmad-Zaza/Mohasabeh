        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endforeach
                    <form enctype="multipart/form-data" action="/info-page-store/{{ $type }}" class="form-horizontal"
                        method="post">
                        @csrf
                        <div class="form-group">
                            <label class="col-sm-2 control-label">brief english</label>
                            <div class="col-sm-10">
                                <input type="text" name="breif_en" title="brief"
                                    value="{{ $data ? $data->breif_en : '' }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="breif_ar" title="brief"
                                    value="{{ $data ? $data->breif_ar : '' }}" class="form-control">
                            </div>
                        </div>
                </div>

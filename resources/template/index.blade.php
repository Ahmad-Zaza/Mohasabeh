                    ...
                    @if ($item->from_scratch)
                        <figure class="col-md-4">
                            <a href="/landingPage/create/{{ $item->id }}" target="_blank" data-size="1600x1067">
                                <div class="container-img-gal"
                                    style="height: 300px; margin: 10px 0;overflow: hidden;    position: relative; width: 100%;">
                                    <div class="img-gal"
                                        style="background-image: url('{{ $item->image_path }}');background-size: contain;background-repeat: no-repeat;background-position: center;height: 100%;
                        position: relative;

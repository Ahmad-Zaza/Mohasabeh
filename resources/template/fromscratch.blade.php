...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="modal fade " id="BackgroundRowModal" tabindex="-1" role="dialog" aria-labelledby="Backgroud Row">
                            ...
                            <div class="col-sm-12">
                                <div>
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#style_dom_ext"
                                                aria-controls="style_dom_ext" role="tab" data-toggle="tab"> style
                                            </a></li>
                                        <li role="presentation"><a href="#settings_dom_ext"
                                                aria-controls="settings_dom_ext" role="tab" data-toggle="tab">
                                                Settings </a></li>
                                        <li role="presentation"><a href="#visible_cols_dom_ext"
                                                aria-controls="visible_cols_dom_ext" role="tab"
                                                data-toggle="tab">Visible cols</a></li>
                                    ...
                                    <div class="tab-content" style='margin-top:20px;'>
                                        <div role="tabpanel" class="tab-pane active" id="style_dom_ext">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label for="cssClassSetting" class="col-sm-3 control-label">Css
                                                        Class</label>
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group" id="BackGroundTypeDiv">
                                                    <label class="col-xs-3 control-label" for="BackgroundType">
                                                        background :</label>
                                                    <div class="col-xs-7"> <input id="BackgroundType"
                                                            class="switch-btn" type="checkbox" value="1"
                                                            checked="" data-on-text=" color "
                                                            data-off-text=" image " data-on-color="danger"></div>
                                                </div>
                                                ...
                                                <div class="form-group" id="bg-image" style="display:none;">
                                                    <label class="control-label col-xs-3"
                                                        for="BackgroundColor">Background Image:</label>
                                                    <div class="col-xs-9">
                                                        <div class="row">
                                                            <div class="col-xs-6" style='padding:0px'>
                                                                <a href="javascript:void(0);"
                                                                    class="photoManagerBackground btn btn-default">
                                                                    Open File Manager </a>
                                                            </div>
                                                            <div class="col-xs-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-3" for="CustomeMinHeight">Min
                                                        Height:</label>
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label col-xs-3" for="CustomeMarginTop"
                                                        style="padding-top:30px"> margin :</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div style="width:25%" class="col-sm-4">Bottom
                                                                    </div>
                                                                    <div style="width:25%" class="col-sm-4">Right
                                                                    </div>
                                                                    <div style="width:25%" class="col-sm-4">Left</div>
                                                                    <span class="input-group-addon"
                                                                        style="border:0px;background:none">&nbsp;</span>
                                                                </div>
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" id="CustomeMarginTop">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" id="CustomeMarginBottom">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" id="CustomeMarginRight">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" id="CustomeMarginLeft">
                                                                    <span class="input-group-addon">px</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-3" for="CustomePaddingLeft"
                                                        style="padding-top:30px"> padding :</label>
                                                    <div class="col-sm-7">
                                                        <div class="row">
                                                            <div class="col-xs-12">
                                                                <div class="input-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" min="0"
                                                                        id="CustomePaddingTop">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" min="0"
                                                                        id="CustomePaddingBottom">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" min="0"
                                                                        id="CustomePaddingRight">
                                                                    <input type="number" class="form-control"
                                                                        style="width:25%" min="0"
                                                                        id="CustomePaddingLeft">
                                                                    <span class="input-group-addon">px</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="settings_dom_ext">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group" id="FullRowMode">
                                                    <label class="col-xs-3 control-label" for="BackgroundFull">Full
                                                        Row:</label>
                                                    <div class="col-xs-7"> <input id="BackgroundFull"
                                                            class="switch-btn" type="checkbox" value="1"
                                                            data-on-text=" Yes " data-off-text=" No "
                                                            data-on-color="danger"></div>
                                                </div>
                                                <div class="form-group" style='display: none; ' id="rowContentMode">
                                                    <label class="col-xs-3 control-label" for="ContentFullRow">Content
                                                        Is Full:</label>
                                                    <div class="col-xs-7"> <input id="ContentFullRow"
                                                            class="switch-btn" type="checkbox" value="1"
                                                            data-on-text=" Yes " data-off-text=" No "
                                                            data-on-color="danger"></div>
                                                </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="visible_cols_dom_ext">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label" for="desktop_hidden">Desktop
                                                        Hide &nbsp;<i class='fa fa-desktop'></i></label>
                                                    <div class="col-sm-8">
                                                        <input id="desktop_hidden" class="switch-btn" type="checkbox"
                                                            value="1" data-on-text=" Hide "
                                                            data-off-text=" Show " data-on-color="danger">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="tablet_hidden" class="col-sm-4 control-label">Tablet
                                                        Hide &nbsp;<i class='fa fa-tablet'></i></label>
                                                    <div class="col-sm-8">
                                                        <input id="tablet_hidden" class="switch-btn" type="checkbox"
                                                            value="1" data-on-text=" Hide "
                                                            data-off-text=" Show " data-on-color="danger">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="mobile_hidden" class="col-sm-4 control-label">Mobile
                                                        Hide &nbsp; <i class='fa fa-mobile-phone'></i></label>
                                                    <div class="col-sm-8">
                                                        <input id="mobile_hidden" class="switch-btn" type="checkbox"
                                                            value="1" data-on-text=" Hide "
                                                            data-off-text=" Show " data-on-color="danger">
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="CancelInsertForm" class="btn btn-default"
                            data-dismiss="modal">Cancel</button>

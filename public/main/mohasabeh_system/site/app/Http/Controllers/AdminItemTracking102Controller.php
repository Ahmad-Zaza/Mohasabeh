        ...
        */
        ...
        public function getIndex(Request $request)
        {
            ...
            $query = DB::table("item_tracking")->select(
                ...
                'bills.id as billId', 'inventory_type_id.name_en as typeEn', 'item_tracking.id as trackingId',
...
//dd($data);
            ...
            return view("report.materialMovement", Array("data" => $data, "items" => $items,'types'=>$types,

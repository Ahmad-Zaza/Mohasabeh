...
class PrivilegesController extends CBController
{
    ...
    {
        $this->module_name = trans("crudbooster.Privilege");
        ...
        $this->col[] = [
            "label" => trans("crudbooster.Role"),
            "name" => "is_superadmin",
            'callback_php' => '($row->is_superadmin)?"<span class=\"label label-success\">المسؤول الأعلى</span>":"<span class=\"label label-default\">معياري</span>"',
        ];

        $this->form = [];
        $this->form[] = ["label" => trans("crudbooster.Name"), "name" => "name", 'required' => true];
    ...
    public function getAdd()
    {
        ...
        $id = 0;
        $data['page_title'] = trans('crudbooster.Add_Role');
    ...
    public function getEdit($id)
    {
        ...
        $page_title = trans('crudbooster.edit_data_page_title', ['module' => trans('crudbooster.Role'), 'name' => $row->name]);

            ...
            <form method='post' action='{{ (@$row->id)?route("PrivilegesControllerPostEditSave")."/$row->id":route("PrivilegesControllerPostAddSave") }}'>
                ...
                <div class="box-body">
                    ...
                    <div id='privileges_configuration' class='form-group'>
                        ...
                        <table class='table table-striped table-hover table-bordered privilage_table'>
                            <thead>
                            <tr class='active'>
                            ...
                            <tr class='info'>
                                ...
                                <th>&nbsp;</th>
                                <th>&nbsp;</th>
                                <td align="center"><input title='{{trans("crudbooster.Check_all_vertical")}}' type='checkbox' id='is_visible'/></td>
                                <td align="center"><input title='{{trans("crudbooster.Check_all_vertical")}}' type='checkbox' id='is_create'/></td>
                                <td align="center"><input title='{{trans("crudbooster.Check_all_vertical")}}' type='checkbox' id='is_read'/></td>
                                <td align="center"><input title='{{trans("crudbooster.Check_all_vertical")}}' type='checkbox' id='is_edit'/></td>
                                <td align="center"><input title='{{trans("crudbooster.Check_all_vertical")}}' type='checkbox' id='is_delete'/></td>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $no = 1;?>
                            @foreach($moduls as $modul)
                                ...
                                <tr>
                                    <td><?php echo $no++;?></td>
                                    <td>{{$modul->name}}</td>
                                    <td class='info' align="center"><input type='checkbox' title='{{trans("crudbooster.Check_all_horizontal")}}'

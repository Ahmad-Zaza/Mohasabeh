      ...
      contextActions: {
        ...
        select: function (e) {
          ...
          (1 == jQuery("#return_relative_url").val() &&
            (t = (t = t.replace(jQuery("#base_url").val(), "")).replace(
              jQuery("#cur_dir").val(),
              ""
            )),
          ...
          "" != r)
            ? 1 == jQuery("#crossdomain").val()
              ? a.postMessage(
                  { sender: "responsivefilemanager", url: t, field_id: r },
                  "*"
                )
              : (jQuery("#" + r, a.document)
                  .val(t)
                ...
                [
                  { label: jQuery("#cancel").val(), class: "btn" },
                  {
                    ...
                    callback: function () {
                      ...
                      window.editor &&
                        "function" == typeof window.editor.getData &&
      ...
      makeContextMenu: function () {
        ...
        y.contextMenu({
          ...
          build: function (t) {
            ...
            return (
              (t.find(".img-precontainer-mini .filetype").hasClass("png") ||
                t.find(".img-precontainer-mini .filetype").hasClass("jpg") ||
                t.find(".img-precontainer-mini .filetype").hasClass("jpeg")) &&
                a &&
                (e.items.edit_img = {
              ...
              (t.find(".img-precontainer-mini .filetype").hasClass("zip") ||
                t.find(".img-precontainer-mini .filetype").hasClass("tar") ||
                t.find(".img-precontainer-mini .filetype").hasClass("gz")) &&
              ...
              (e.items.info = {
                type: "html",
                html:
                  "<strong>" + jQuery("#lang_file_info").val() + "</strong>",
              }),
              (e.items.name = {
      ...
      bindGridEvents: function () {
        ...
        function r(e) {
          ...
          "apply_multiple" == a
            ...
            : window[a](e.attr("data-file"), jQuery("#field_id").val(), e);
        }
            ...
            e.preventDefault(),
              y.ajax({
                ...
                success: function (e) {
                  bootbox.modal(
                    e,
                    " " + a.parent().parent().parent().find(".name").val()
                  );
                },
              });
          }),
          ...
          e.on("click", ".rename-file", function () {
            ...
            bootbox.prompt(
              ...
              function (e) {
                null !== e &&
                  (e = Q(e)) != r &&
                  g("rename_file", t, e, a, "apply_file_rename");
              },
              r
            );
          }),
          e.on("click", ".rename-folder", function () {
            ...
            bootbox.prompt(
              ...
              function (e) {
                null !== e &&
                  (e = Q(e).replace(".", "")) != r &&
                  g("rename_folder", t, e, a, "apply_folder_rename");
              },
              r
            );
          }),
              ...
              e &&
                r(function () {
                  jQuery("li", "ul.grid ").each(function () {
                    var e = jQuery(this);
                    "" != a &&
                    -1 == e.attr("data-name").toLowerCase().indexOf(a)
                      ? e.hide(100)
                      : e.show(100);
                  }),
                    y
                      .ajax({ url: "ajax_calls.php?action=filter&type=" + a })
                      .done(function (e) {
                        "" != e && bootbox.alert(e);
                      }),
                    r(function () {
                      _(
                        0 != jQuery("#descending").val(),
                        "." + jQuery("#sort_by").val()
                      ),
                        b();
                    }, 500);
          ...
          (i = jQuery("#sort_by").val() !== e.attr("data-sort") || 0 == i),
            r
              ? (y.ajax({
                ...
                i
                  ? jQuery(".sort-" + e.attr("data-sort")).addClass(
                      "descending"
                    )
                  : jQuery(".sort-" + e.attr("data-sort")).addClass(
                      "ascending"
  ...
  function Q(e) {
    return null != e
      ? ("true" == jQuery("#transliteration").val() &&
        ...
        (e = (e = (e = (e = (e = e.replace('"', "")).replace("'", "")).replace(
          "/",
          ""
        )).replace("\\", "")).replace(/<\/?[^>]+(>|$)/g, "")),
        y.trim(e))
  ...
  jQuery(document).ready(function () {
    ...
    s.makeSort(t),
      ...
      jQuery(".create-file-btn").on("click", function () {
        jQuery("#textfile_create_area").parent().parent().remove(),
          y
            .ajax({ type: "GET", url: "ajax_calls.php?action=new_file_form" })
            .done(function (e) {
              bootbox.dialog(
                e,
                [
    ...
    if (
      ...
      r.on("mouseover", function () {
        0 == jQuery("#view").val() &&
          !1 === jQuery("#main-item-container").hasClass("no-effect-slide") &&
          jQuery(this)
            .find(".box:not(.no-effect)")
            .animate({ top: "-26px" }, { queue: !1, duration: 300 });
      }),
        r.on("mouseout", function () {
          0 == jQuery("#view").val() &&
            jQuery(this)
              .find(".box:not(.no-effect)")
              .animate({ top: "0px" }, { queue: !1, duration: 300 });
        });
    }
              ...
              y
                ...
                .done(function (e) {
                  ...
                  "" != e
                    ...
                    : ((a =
                        void 0 !== r
                          ? r.hasClass("back-directory")
                            ? r.find(".path").val()
                            : r.closest("figure").attr("data-path")
                          : jQuery("#sub_folder").val() +
                            jQuery("#fldr_value").val()),
                      y
                        .ajax({
                        ...
                        .done(function (e) {
                          "" != e
                            ? (bootbox.alert(e), t.parent().show(100))
                            : (jQuery("#clipboard").val("0"),
                              f(!1),
                              t.parent().remove());
                        }));
    ...
    (apply = function (e, a) {
      ...
      if ((1 == o.length && (u = o[0]), "" != a)) {
        if (1 == jQuery("#crossdomain").val())
          t.postMessage(
            { sender: "responsivefilemanager", url: u, field_id: a },
            "*"
          );
        else
          jQuery("#" + a, t.document)
        ...
        1 == jQuery("#crossdomain").val()
          ...
          ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, i),
    ...
    (apply_link = function (e, a) {
      ...
      (1 == i.length && (n = i[0]), "" != a)
        ? 1 == jQuery("#crossdomain").val()
          ? t.postMessage(
              { sender: "responsivefilemanager", url: i[0], field_id: a },
              "*"
            )
          : (jQuery("#" + a, t.document)
              .val(n)
    ...
    (apply_any = function (e) {
      if (1 == jQuery("#crossdomain").val())
        ...
        var a =
          ((t = new RegExp("(?:[?&]|&)" + "CKEditorFuncNum" + "=([^&]+)", "i")),

...
use Session;
	...
	class AdminLandingPagesController extends CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Code','name'=>'code','type'=>'textarea','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'User Id','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'user,id'];
			$this->form[] = ['label'=>'Background','name'=>'background','type'=>'text','v
			idation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Background Image','name'=>'background_image','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'From Scratch','name'=>'from_scratch','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Background Color','name'=>'background_color','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Code","name"=>"code","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			...
			//$this->form[] = ["label"=>"Background","name"=>"background","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Background Image","name"=>"background_image","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"From Scratch","name"=>"from_scratch","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

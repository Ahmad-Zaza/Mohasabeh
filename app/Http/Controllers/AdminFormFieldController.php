...
use Session;
	...
	class AdminFormFieldController extends CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Field Id","name"=>"field_id","join"=>"fields,title"];
			$this->col[] = ["label"=>"Required","name"=>"required"];
			...
			$this->form[] = ['label'=>'Field Id','name'=>'field_id','type'=>'select2','width'=>'col-sm-10','datatable'=>'fields,title'];
			$this->form[] = ['label'=>'Required','name'=>'required','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Field Id","name"=>"field_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"field,id"];
			//$this->form[] = ["label"=>"Required","name"=>"required","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

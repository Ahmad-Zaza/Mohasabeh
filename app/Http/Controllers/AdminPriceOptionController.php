<?php namespace App\Http\Controllers;
	...
	class AdminPriceOptionController extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Value','name'=>'value','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Name En','name'=>'name_en','type'=>'text','validation'=>'required|string','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Name Ar','name'=>'name_ar','type'=>'text','validation'=>'required|string','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Month Price','name'=>'month_price','type'=>'money','validation'=>'required|min:0','width'=>'col-sm-10'];

...
class AdminCustomersController extends CBController
{
    ...
    public function saveRenewalSubscription()
    {
        ...
        $sql = "UPDATE package_config SET package_id=?, users_num=?, inventories_num=?, currencies_num=?, attachs_size=?,subscription_start_date=?, backups_size=?, subscription_end_date=?,free_trial_start_date=null,free_trial_end_date=null WHERE id=1";

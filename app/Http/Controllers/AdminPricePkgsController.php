...
class AdminPricePkgsController extends CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "Storage", "name" => "storage_attached_size" , 'callback_php' => '($row->storage_attached_size ? $row->storage_attached_size . " MB" : "")'];
        ...
        $this->form[] = ['label' => 'Monthly Price', 'name' => 'monthly_price', 'type' => 'number', 'width' => 'col-sm-9'];
        $this->form[] = ['label' => 'Six Month_price', 'name' => 'six_month_price', 'type' => 'number', 'width' => 'col-sm-9'];
        ...
        $this->form[] = ['label' => 'Storage', 'name' => 'storage', 'type' => 'number', 'validation' => 'required', 'width' => 'col-sm-9', 'help' => 'Size in GB'];
        ...
        $this->sub_module[] = ['label' => 'Options', 'path' => 'price_pkg_options27', 'parent_columns' => 'title_en,title_ar', 'foreign_key' => 'price_pkg_id', 'button_color' => 'success'];

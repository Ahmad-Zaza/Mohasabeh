...
class ImportDataGuideController extends \crocodicstudio_voila\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		$this->col = [];
		$this->col[] = array("label" => "Account Name", "name" => "account_name");
		$this->col[] = array("label" => "Received Amount", "name" => "received_amount");
		$this->col[] = array("label" => "Paamount", "name" => "paid_amount");
		$this->col[] = array("label" => "Currency", "name" => "currency");
	...
	{
		$data = "";
		return view("data.guide", array("data" => $data));
	}
}
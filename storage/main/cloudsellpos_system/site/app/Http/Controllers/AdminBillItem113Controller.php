<?php namespace App\Http\Controllers;
	...
	class AdminBillItem113Controller extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Bill Id","name"=>"bill_id","join"=>"bill,id"];
			$this->col[] = ["label"=>"Item Id","name"=>"item_id","join"=>"item,id"];
		...
		$this->form[] = ["label"=>"Unit Price","name"=>"unit_price","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

...
class ClosingAccountsController extends \crocodicstudio_voila\crudbooster\controllers\CBController
{
	...
	public function getIndex(Request $request)
	{
		...
		$closing_types = ClosingAccountType::where('active', '1')->get();

		$res = ClosingAccountType::find($closing_account_type);
	...
	public function export($filter)
	{
		...
		$heading = array(
			"account_name" => trans('modules.account')
		);
		$empty_row = array(
			''
		);
		$result = array(
			"account_name" => trans('modules.total_balance')
		);

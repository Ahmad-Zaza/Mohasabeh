<?php namespace App\Http\Controllers;
	...
	class AdminItemTracking92Controller extends \crocodicstudio_voila\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Inventory Type Id","name"=>"inventory_id_type_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"inventory_type,id"];
			//$this->form[] = ["label"=>"Source","name"=>"source","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Destination","name"=>"destination","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Bill Id","name"=>"bill_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"bill,id"];
			//$this->form[] = ["label"=>"Note","name"=>"note","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Transaction Operation","name"=>"transaction_operation","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    public function hook_before_edit(&$postdata,$id) {
			...
			$postdata["inventory_id_type_id"]=1;
			$postdata["transaction_operation"]="in";

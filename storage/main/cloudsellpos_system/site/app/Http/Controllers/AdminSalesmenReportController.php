	    ...
	    */
        ...
        public function getIndex(\Illuminate\Http\Request $request)
        {
            ...
            $query = DB::table("bills")->select(
                'bills.date as billDate','bills.amount as billAmount','bills.note as billNote','bills.is_cash',
                'bills.p_code as billCode','bills.id as billId','bills.bill_type_id as type',
                'p1.name_ar as personName', 'p2.name_ar as personName1', 'bills.currency_id as currency_id',

<?php namespace App\Http\Controllers;
	...
	class AdminBillItemController extends \crocodicstudio_voila\crudbooster\controllers\CBController {

	    public function cbInit() {
	    	# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->table 			   = "bill_item";
			$this->title_field         = "id";
			$this->limit               = 20;
			...
			$this->col = [];
			$this->col[] = ["label"=>"Bill Id","name"=>"bill_id","join"=>"bills,code"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Bill Id','name'=>'bill_id','type'=>'select2','width'=>'col-sm-10','datatable'=>'bill,code'];
			$this->form[] = ['label'=>'Item Id','name'=>'item_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'item,name_ar'];
			$this->form[] = ['label'=>'Unit Price','name'=>'unit_price','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

                                    ...
                                    @push('bottom')
                                        <script type="text/javascript">
                                            ...
                                            function getSum() {
                                                ...
                                                $("#after_discount").val(sum - discount);
                                                var currency=($("#currency_id").val()=="")?1:$("#currency_id").val();
                                                var is_cash = $("input[name='is_cash']:checked"). val();
                                                var type=$("#bill_type_id").val();
                                                var param={
                                    ...
                                    <input type='button' class='btn btn-default' id="btn-reset-form-{{$name}}" onclick="resetForm{{$name}}()"
                                     ...
                                     @if($name == 'adafmad')
                                        <input type='button' id='btn-add-table-{{$name}}' class='btn btn-primary' onclick="addToTable{{$name}}()"
                                           value='{{trans("crudbooster.button_add_to_items")}}'/>
                                     @else
                                        <input type='button' id='btn-add-table-{{$name}}' class='btn btn-primary' onclick="addToTable{{$name}}()"

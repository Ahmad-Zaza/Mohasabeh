        ...
        <div class="col-sm-5">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <strong>عناصر القائمة (الفعالة)</strong> <span id='menu-saved-info' style="display:none" class='pull-right text-success'><i
                ...
                <div class="panel-body clearfix">
                    ...
                    @if(count($menu_active)==0)
                        <div align="center">لايوجد عناصر بالقائمة. قم بإضافة عناصر للقائمة.</div>
                    @endif
                </div>
            </div>
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <strong>عناصر القائمة (الغير فعالة)</strong>
                </div>
                <div class="panel-body clearfix">
                    ...
                    @if(count($menu_inactive)==0)
                        <div align="center" id='inactive_text' class='text-muted'>لا يوجد عناصر غير فعالة.</div>
                    @endif
                </div>
            </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data" action='{{CRUDBooster::mainpath("add-save")}}'>
                        ...
                        <p align="right"><input type='submit' class='btn btn-primary' value='إضافة'/></p>
                    </form>
                </div>
            </div>
        </div>

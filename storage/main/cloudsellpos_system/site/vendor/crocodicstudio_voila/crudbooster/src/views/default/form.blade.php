                                    ...
                                    @if($button_save && $command != 'detail' )
                                      ...
                                      <?php
                                        ...
                                        @if(CRUDBooster::getCurrentMethod() == 'getEdit') 
                                            <input type="submit" name="submit" value='{{trans("crudbooster.Edit")}}' id='btn-save-data' class='btn btn-success'>
                                        @else
                                            <input type="submit" name="submit" value='{{trans("crudbooster.button_save")}}' id='btn-save-data' class='btn btn-success'>
                                        @endif       

                ...
                <div class="pull-{{ trans('crudbooster.left') }}">
                    <div class="selected-action" style="display:inline-block;position:relative;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {{-- fesal --}}
                            <li><a href="javascript:void(0)" data-name='is_active' title='is active'><i
                                class="fa fa-check"></i> is Active</a></li>

                                <li><a href="javascript:void(0)" data-name='is_in_active' title='is inactive'><i
                                    class="fa fa-close"></i> is inactive</a></li>
                            @if($button_selected)

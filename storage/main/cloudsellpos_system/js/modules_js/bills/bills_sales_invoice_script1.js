...
$('#adafmaditem_id').change(function () {
    ...
    $.get('/items/getPrice/currency' + curr_id + '/item' + id + '/customer' + customer, function (res) {
        console.log(res);
...
$('#btn-add-table-adafmad').click(function () {
    ...
    if (debit == '' && is_cash == 0) {
        notify(_WARNING,_YOU_MUST_CHOOSE_CUSTOMER,'warning');
    }
...
$(document).ready(function () {
$('#panel-form-adafmad .child-form-area').append(`
    <div class='form-group'>
        <label class='control-label col-sm-2'></label>
        <div class='col-sm-10'>
        <input id='adafmad_is_free' type='checkbox' name='child-is_free'>
        ${_THIS_ITEM_IS_FREE}
        </div>
    </div>
`);
